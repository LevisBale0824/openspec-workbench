// ---------------------------------------------------------------------------
// Zero Backend Adapter
// ---------------------------------------------------------------------------
// Zero is an opencode-compatible agent (CLI: `zero serve`). Its HTTP server
// exposes the same REST/SSE API surface as opencode server, so we reuse the
// opencode REST client (`app/utils/opencode.ts`) directly.
// ---------------------------------------------------------------------------

import * as opencodeApi from "../utils/opencode";
import type { BackendAdapter } from "./types";

export function createZeroAdapter(): BackendAdapter {
  return {
    kind: "zero",
    label: "Zero",
    capabilities: {
